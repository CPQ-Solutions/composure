...
// Edited by Michael Wheeler. Adding the join function from q/util
//Modified by Kenny Browne to allow for an array of promises to be passed in
//Syntax array with final index being the callback function
Q.join = function () {
   var values = Array.prototype.slice.call(arguments);
    var fulfilled = values.pop();
	if(typeof fulfilled === "object"){
		var arr = true;
		values = fulfilled;
		fulfilled = values.pop();
	}
    var reasons;
