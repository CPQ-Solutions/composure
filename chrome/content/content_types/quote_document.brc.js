...
function quote_document(params) {
	...
	var add_action_links = function () {
		...
		if (attributePref) {
			jQuery("[id*='attr_wrapper_1_'],.line-item-grid-body tr:first-of-type td[id*='attr_wrapper_']", doc).each(function () {
...
quote_document.prototype = new BR_Content();
